       ...
       <div class="container">
        <div class="row">
          <div data-aos="fade-right" data-aos-once="true" class="col-md-7 col-md-push-5">
            ...
            <img class="featurette-image img-responsive img-rounded" src="assets/feature_info_images/training_manager/ExternalTraining.png" style="background-size:cover; background-repeat:none;">
            </div>
          </div>
        </div>
      </div>
