...
<head>
    ...
    <title>EWG Technology | Rosterfy | Branding Manager </title>
    <!-- Bootstrap Core CSS -->
       ...
       <div class="container">
        <div class="row">
          <div class="col-md-7 col-md-push-5" data-aos="fade-right" data-aos-once="true" data-aos-offset="300">
            <h2 class="featurette-heading">Training</h2>
        ...
        <div class="container">
          <div class="row featurette">
            <div class="col-md-7" data-aos="fade-left" data-aos-once="true" data-aos-offset="400">
              ...
              <p class="lead"> Setup a uniqie registration page and gather data from users registering based on a specific brand or event series.</p>
            </div>
       ...
       <div class="container">
        <div class="row">
          <div class="col-md-7 col-md-push-5" data-aos="fade-right" data-aos-once="true" data-aos-offset="500">
            ...
            <p class="tech-lead"> Customize your post event certificates here to be branded or event series specific.</p>
          </div>
