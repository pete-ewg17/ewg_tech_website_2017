    ...
    <div class="container">
      <div class="row featurette">
        <div class="col-md-12 text-center" data-aos="fade-left" data-aos-once="true">
          <h2>SMS</h2>
          <p>Track, manage and schedule SMS.</p>      
        </div>
      </div>
    </div>
  </div>
       ...
       <div class="container">
        <div class="row">
          <div data-aos="fade-right" data-aos-once="true" class="col-md-7 col-md-push-5">
            ...
            <p class="tech-lead">View your SMS History including delivery status, time, date and more. </p>
          </div>
        ...
        <div class="container">
          <div class="row featurette">
            <div class="col-md-7" data-aos="fade-left" data-aos-once="true">
              <h2>SMS Templates</h2>
              <p>Add new or edit existing SMS templates.</p>
            </div>
       ...
       <div class="container">
        <div class="row">
          <div class="col-md-7 col-md-push-5" data-aos="fade-right" data-aos-once="true" data-aos-offset="300">
            <h2 class="featurette-heading">Incoming SMS</h2>
            <p class="tech-lead">Track SMS responses from your users.</p>
          </div>
       ...
       <div class="container">
        <div class="row">
          <div class="col-md-7 col-md-push-5" data-aos="fade-right" data-aos-once="true" data-aos-offset="500">
            ...
            <p class="tech-lead">Get your communications ready in advance by scheduling your SMS.</p>
          </div>
