<?php
$file_base = "../";
$title = "Custom Registration Settings";
$desc = "Ensure that you are collecting all the core information required from your users with your custom registration form.";
    ...
    <div class="container">
      <div class="row featurette">
        <div class="col-md-12 text-center" data-aos="fade-left" data-aos-once="true">
          <h2>Custom Registration Settings</h2>
          <p>Ensure that you are collecting all the core information required from your users with your custom registration form.</p>      
        </div>
      </div>
    </div>
  </div>
