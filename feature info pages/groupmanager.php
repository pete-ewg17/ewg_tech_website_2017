       ...
       <div class="container">
        <div class="row">
          <div class="col-md-7 col-md-push-5" data-aos="fade-right" data-aos-once="true" data-aos-offset="500">
            ...
            <p class="tech-lead">Archive dorment workforce groups. When using Rosterfy and archived groups, your lists to choose groups will be a lot shorter and you can keep your old groups as a backup just in case they need to be called upon later.</p>
          </div>
        ...
        <div class="container">
          <div class="row featurette">
            <div class="col-md-7" data-aos="fade-left" data-aos-once="true" data-aos-offset="400">
              ...
              <p class="lead"> To fill a shift quickly, you can easily import a Workforce Group. Perfect for when you need to fill 20 positions at a drink station in one allocation.</p>
            </div>
            <div class="col-md-5" data-aos="fade-left" data-aos-once="true" data-aos-offset="400">
              <img class="featurette-image img-responsive img-rounded" src="http://placehold.it/600/500" alt="Workforce Portals Platform">
            </div>
